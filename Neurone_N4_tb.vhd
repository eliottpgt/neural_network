...
-- Testbench entity for Neurone_N4
entity Neurone_N4_tb is
end Neurone_N4_tb;

-- Testbench architecture with test stimulus generation
architecture architecture_tb of Neurone_N4_tb is
...
NEURONE_TEST : entity work.Neurone_N4
	...
	begin
		...
		-- Xi = (0,0,0,2) -> Y = 27*2 = 54 < 100 -> Z = 1
		wait for 10 ns;
		Xi_tb <= (0 => 0, 1 => 0, 2 => 0, 3 => 2);
		wait for 30 ns;

		-- Test 2: Sum above threshold (Y > T) -> Z should be VMAX = 16
		-- Xi = (4,4,4,4) -> Y = 27*16 = 432 > 100 -> Z = 16
		Xi_tb <= (0 => 4, 1 => 4, 2 => 4, 3 => 4);
		wait for 30 ns;
